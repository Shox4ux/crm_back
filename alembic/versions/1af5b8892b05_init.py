...
Revision ID: 1af5b8892b05
Revises: 
Create Date: 2026-04-09 00:52:58.848697
...
def upgrade() -> None:
    ...
    sa.Column('client_id', sa.Integer(), nullable=True),
    sa.Column('status', sa.Integer(), nullable=False),
    sa.Column('delivery_on', sa.DateTime(timezone=True), nullable=True),
    ...
    op.create_table('order_cancel_info',
    sa.Column('order_id', sa.Integer(), nullable=True),
    sa.Column('cancel_reason', sa.String(), nullable=False),
    sa.Column('cancel_type', sa.Integer(), nullable=False),
    sa.Column('canceler_id', sa.Integer(), nullable=False),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=True),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['canceler_id'], ['admins.id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('order_cancel_info')
